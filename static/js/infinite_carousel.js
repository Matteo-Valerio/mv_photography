...
document.addEventListener("DOMContentLoaded", function(event) {
    var carousel = document.getElementById('inf-carousel');
    ...
    document.getElementById('inf-carousel').style.width = (amount * moveOffset) + 'px';
    ...
    document.getElementById('inf-carousel').insertBefore(document.getElementById('inf-carousel').children[4], document.getElementById('inf-carousel').children[0]);
    ...
    // Aggiungi questa parte per far scorrere automaticamente il carosello
    setInterval(function() {
        next();
    }, 1000); // Imposta l'intervallo in millisecondi (5 secondi nel caso sopra)
});
